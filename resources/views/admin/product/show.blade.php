                                                ...
                                                <tr>
                                                    <td class="text-muted">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--end::Svg Icon-->Mahsulot nomi</div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="text-muted">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--end::Svg Icon-->1 tonna narxi:</div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="text-muted">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--end::Svg Icon-->1 tonna uzunligi:</div>
                                                    </td>
                                                    <td class="fw-bolder text-end">{{$product->length_per_ton}} Metr</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-muted">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--end::Svg Icon-->1 metr uchun narx:</div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="text-muted">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--end::Svg Icon-->1 pochka narxi:</div>
                                                    </td>
                                                    <td class="fw-bolder text-end">{{$product->price_per_package}} $</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-muted">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--end::Svg Icon-->1 dona uchun narx:</div>
                                                    </td>
                                            ...
                                            <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                                ...
                                                @if($product->items_per_package)
                                                    <tr>
                                                        ...
                                                        <td class="fw-bolder text-end">
                                                            <a  class="text-gray-600 text-hover-primary">{{$product->items_per_package}} ta</a>
                                                        </td>
                                                    </tr>
                                                @endif
                                                @if($product->total_units)
                                                    <tr>
                                                        ...
                                                        <td class="fw-bolder text-end">
                                                            <a  class="text-gray-600 text-hover-primary"> {{$product->total_units}} ta</a>
                                                        </td>
                                                    </tr>
                                                @endif
                                                @if($product->package_weight)
                                                    <tr>
                                                        ...
                                                        <td class="fw-bolder text-end">
                                                            <a  class="text-gray-600 text-hover-primary">{{$product->package_weight}} Tonna</a>
                                                        </td>
                                                    </tr>
                                                @endif
                                                @if($product->package_length)
                                                    <tr>
                                                        ...
                                                        <td class="fw-bolder text-end">
                                                            <a  class="text-gray-600 text-hover-primary"> {{$product->package_length}} metr</a>
                                                        </td>
                                                    </tr>
                                                @endif
                                                @if($product->weight_per_meter)
                                                    <tr>
                                                        ...
                                                        <td class="fw-bolder text-end">
                                                            <a  class="text-gray-600 text-hover-primary">{{$product->weight_per_meter}} tonna</a>
                                                        </td>
                                                    </tr>
                                                @endif
                                                @if($product->weight_per_item)
                                                    <tr>
                                                        ...
                                                        <td class="fw-bolder text-end">
                                                            <a  class="text-gray-600 text-hover-primary"> {{$product->weight_per_item}} tonna</a>
                                                        </td>
                                                    </tr>
                                                @endif
                                                @if($product->grains_package)
                                                    <tr>
                                                        ...
                                                        <td class="fw-bolder text-end">
                                                            <a  class="text-gray-600 text-hover-primary">  {{$product->grains_package}} ta</a>
                                                        </td>
                                                    </tr>
                                                @endif
                                                @if($product->total_packages)
                                                    <tr>
                                                        ...
                                                        <td class="fw-bolder text-end">
                                                            <a  class="text-gray-600 text-hover-primary">  {{$product->total_packages}} ta</a>
                                                        </td>
                                                    </tr>
                                                @endif
                                                @if($product->items_in_package)
                                                    <tr>
                                                        ...
                                                        <td class="fw-bolder text-end">
                                                            <a  class="text-gray-600 text-hover-primary">  {{$product->items_in_package}} ta</a>
                                                        </td>
                                                    </tr>
                                                @endif
                                                @if($product->total_weight)
                                                    <tr>
                                                        ...
                                                        <td class="fw-bolder text-end">
                                                            <a  class="text-gray-600 text-hover-primary"> {{$product->total_weight}} Tonna</a>
                                                        </td>
                                                    </tr>
                                                @endif
                                                <!--end::Rewards-->
                                        ...
                                        <div>
                                            ...
                                            <div class="stock-details">
                                                <div>
                                                    ...
                                                    <input value="{{$product->items_per_package}}"  readonly style="background-color: #F5F5F7; border: 1px solid #ccc; color: #333;" >
                                                </div>
                                                <div>
                                                    <label for="pochkada-dona">Pochkada donalar soni</label>
                                                    <input value="{{$product->total_packages}}"  readonly style="background-color: #F5F5F7; border: 1px solid #ccc; color: #333;" >
                                                </div>
                                                <div>
                                                    <label for="aloqida-dona">Alohida dona</label>
                                                    <input  value="{{$product->total_units}}"  readonly style="background-color: #F5F5F7; border: 1px solid #ccc; color: #333;" >
                                                </div>
                                                <div>
                                                    <label for="tonna">Umumiy Tonna</label>
                                                    <input  value="{{$product->total_weight}}"  readonly style="background-color: #F5F5F7; border: 1px solid #ccc; color: #333;" >
                                                </div>
                                            </div>
