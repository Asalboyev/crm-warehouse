                            ...
                            <div class="mb-10">
                                ...
                                <div>
                                    <select class="form-select form-select-solid select2-hidden-accessible"
                                        ...
                                        data-select2-id="select2-data-7-r1q8" tabindex="-1" aria-hidden="true">
                                        <option data-select2-id="select2-data-9-apqm"></option>
                                        <option value="1">Approved</option>
                                        <option value="2">Pending</option>
                                        <option value="2">In Process</option>
                                        <option value="2">Rejected</option>
                                    </select><span class="select2 select2-container select2-container--bootstrap5"
                                        dir="ltr" data-select2-id="select2-data-8-u1jx" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-zssk-container"
                                                aria-controls="select2-zssk-container"><span
                                                    class="select2-selection__rendered" id="select2-zssk-container"
                                ...
                                <div class="px-7 py-5" data-kt-user-table-filter="form">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <select
                                            ...
                                            data-hide-search="true" data-select2-id="select2-data-10-pvsd" tabindex="-1"
                                            aria-hidden="true">
                                            <option data-select2-id="select2-data-12-scgw"></option>
                                            ...
                                            dir="ltr" data-select2-id="select2-data-11-xtc4" style="width: 100%;"><span
                                                class="selection"><span
                                                    class="select2-selection select2-selection--single form-select form-select-solid fw-bolder"
                                                    role="combobox" aria-haspopup="true" aria-expanded="false"
                                                    tabindex="0" aria-disabled="false"
                                                    aria-labelledby="select2-cbww-container"
                                                    aria-controls="select2-cbww-container"><span
                                                        class="select2-selection__rendered" id="select2-cbww-container"
                                                        role="textbox" aria-readonly="true" title="Select option"><span
                                                            class="select2-selection__placeholder">Select
                                                            option</span></span><span class="select2-selection__arrow"
                                                        role="presentation"><b
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <select
                                            ...
                                            data-hide-search="true" data-select2-id="select2-data-13-et5i" tabindex="-1"
                                            aria-hidden="true">
                                            <option data-select2-id="select2-data-15-sl53"></option>
                                            <option value="Enabled">Enabled</option>
                                        </select><span class="select2 select2-container select2-container--bootstrap5"
                                            dir="ltr" data-select2-id="select2-data-14-kaz8" style="width: 100%;"><span
                                                class="selection"><span
                                                    class="select2-selection select2-selection--single form-select form-select-solid fw-bolder"
                                                    role="combobox" aria-haspopup="true" aria-expanded="false"
                                                    tabindex="0" aria-disabled="false"
                                                    aria-labelledby="select2-yeye-container"
                                                    aria-controls="select2-yeye-container"><span
                                                        class="select2-selection__rendered" id="select2-yeye-container"
                                                        role="textbox" aria-readonly="true" title="Select option"><span
                                                            class="select2-selection__placeholder">Select
                                                            option</span></span><span class="select2-selection__arrow"
                                                        role="presentation"><b
                                        ...
                                        <form id="kt_modal_export_users_form"
                                            ...
                                            <div class="fv-row mb-10">
                                                ...
                                                <select name="role" data-control="select2"
                                                    ...
                                                    class="form-select form-select-solid fw-bolder select2-hidden-accessible"
                                                    data-select2-id="select2-data-16-xdv2" tabindex="-1"
                                                    aria-hidden="true">
                                                    <option data-select2-id="select2-data-18-ddos"></option>
                                                    <option value="Administrator">Administrator</option>
                                                    <option value="Analyst">Analyst</option>
                                                    <option value="Developer">Developer</option>
                                                    <option value="Support">Support</option>
                                                    ...
                                                    dir="ltr" data-select2-id="select2-data-17-ii91"
                                                    style="width: 100%;"><span class="selection"><span
                                                            class="select2-selection select2-selection--single form-select form-select-solid fw-bolder"
                                                            role="combobox" aria-haspopup="true" aria-expanded="false"
                                                            tabindex="0" aria-disabled="false"
                                                            aria-labelledby="select2-role-e9-container"
                                                            aria-controls="select2-role-e9-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-role-e9-container" role="textbox"
                                            ...
                                            <div class="fv-row mb-10 fv-plugins-icon-container">
                                                ...
                                                <select name="format" data-control="select2"
                                                    ...
                                                    class="form-select form-select-solid fw-bolder select2-hidden-accessible"
                                                    data-select2-id="select2-data-19-2db8" tabindex="-1"
                                                    aria-hidden="true">
                                                    <option data-select2-id="select2-data-21-trmf"></option>
                                                    ...
                                                    class="select2 select2-container select2-container--bootstrap5"
                                                    dir="ltr" data-select2-id="select2-data-20-hpfw"
                                                    style="width: 100%;"><span class="selection"><span
                                                            class="select2-selection select2-selection--single form-select form-select-solid fw-bolder"
                                                            role="combobox" aria-haspopup="true" aria-expanded="false"
                                                            tabindex="0" aria-disabled="false"
                                                            aria-labelledby="select2-format-xz-container"
                                                            aria-controls="select2-format-xz-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-format-xz-container" role="textbox"
